// handle.h - Smart Pointer Template Library for Handles
// (C) Kenny Kerr (http://kennykerr.ca)
// v2013-11-27 downloaded from http://dx.codeplex.com
// Changes by Markus M. Egger:
// - 2018-01-21: Added Registry key traits and handle definitions as per
//               Mr Kerr's Pluralsight course
...
namespace KennyKerr
{
    ...
    // Added by Markus M. Egger following Mr Kerr's Pluralsight COM course.
    ...
    // Added by Markus M. Egger following Mr Kerr's Pluralsight COM course.
    using registry_key_handle = unique_handle<registry_key_traits>;
}
